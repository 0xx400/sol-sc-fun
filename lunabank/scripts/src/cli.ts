...
const printTokenMint =  (
    ...
    // console.log("res = recipeMint ", accData);
...
program
    ...
    .action(async (directory, cmd) => {
        ...
        // const recipeTokenAccountPubkey = new Keypair().publicKey;
        // const recipeTokenAccData = await connection.getAccountInfo(
        //     recipeTokenAccountPubkey
        // );
        //
        // const token = new Token(connection, recipeTokenMint, TOKEN_PROGRAM_ID, callerKp)
        // const recipeTokenAccData = await token.getOrCreateAssociatedAccountInfo(toPublicKey)
        ...
        if (recipeTokenAccData === null || recipeTokenAccData.data.length === 0) {
            ...
            // const createRecipeTokenAccountIx = SystemProgram.createAccount({
            //     programId: TOKEN_PROGRAM_ID,
            //     space: AccountLayout.span,
            //     lamports: await connection.getMinimumBalanceForRentExemption(
            //         AccountLayout.span
            //     ),
            //     fromPubkey: callerKp.publicKey,
            //     newAccountPubkey: recipeTokenAccountPubkey,
            // });
            // const initRecipeTokenAccountIx = Token.createInitAccountInstruction(
            //     TOKEN_PROGRAM_ID,
            //     recipeTokenMint,
            //     tempXTokenAccountKeypair.publicKey,
            //     callerKp.publicKey
