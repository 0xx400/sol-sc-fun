...
exports.LUNADEPOSIT_ACCOUNT_DATA_LAYOUT = exports.LUNABANK_ACCOUNT_DATA_LAYOUT = exports.getTokenBalance = exports.getProgramId = exports.getKeypair = exports.getPrivateKey = exports.getPublicKey = exports.writePublicKey = exports.getKeypairByPath = exports.logError = void 0;
...
var getKeypairByPath = function (name) {
    return web3_js_1.Keypair.fromSecretKey(Uint8Array.from(JSON.parse(fs.readFileSync(name))));
};
exports.getKeypairByPath = getKeypairByPath;
...
var getPrivateKey = function (name) {
    return Uint8Array.from(JSON.parse(fs.readFileSync("./keys/".concat(name, ".json"))));
};
...
exports.LUNABANK_ACCOUNT_DATA_LAYOUT = BufferLayout.struct([
...
exports.LUNADEPOSIT_ACCOUNT_DATA_LAYOUT = BufferLayout.struct([
    BufferLayout.u8("isInitialized"),
    publicKey("owner"),
    uint64("amount"),
